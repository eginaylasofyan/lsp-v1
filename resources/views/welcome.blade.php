...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="#home">E' TourTravel<span></span></a>
  ...
  <div class="hero-wrap js-fullheight" style="background-image: url('images/pem.jpg')" data-stellar-background-ratio="0.5">
      ...
      <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
        <div class="col-md-9 text text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
          ...
          <h1 data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">
            Make beautiful memories while traveling
          </h1>
        </div>
      </div>
    </div>
  ...
  <section class="ftco-section testimony-section bg-bottom" style="background-image: url(images)" id="blog">
    <div class="container">
      <div class="row justify-content-center pb-4">
        <div class="col-md-12 heading-section text-center ftco-animate">
  ...
  <footer class="ftco-footer bg-bottom" style="background-image: url(images)" id="contact">
    <div class="container">
      <div class="row mb-5">
        <div class="col-md">
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="#" class="py-2 d-block">Traveling Abroad</a></li>
        ...
        <div class="col-md">
          <div class="ftco-footer-widget mb-4">
            ...
            <div class="block-23 mb-3">
              <ul>
                <li>
                  <span class="icon icon-map-marker"></span><span class="text">Cibinong, Kab. Bogor, Indonesia</span>
                </li>
                <li>
                  <a href="#"><span class="icon icon-phone"></span><span class="text">08979119154</span></a>
                </li>
                <li>
                  <a href="#"><span class="icon icon-envelope"></span><span class="text">eginayla02@gmail.com</span></a>
                </li>
              </ul>
            </div>
          </div>
